...
<logic:notPresent name='uKAction' scope='request'>
 <logic:redirect forward='ukaction'/>
</logic:notPresent>

<logic:notPresent name="ukForm" property="action">
...
<logic:present name="ukForm" property="action">
<bean:define id="action" name="ukForm" property="action"/>
...
<BR>
<html:form action="/ukaction?action=report" onsubmit="return checkFields();">
...
<html:form method="post" action="/ukaction?action=null">
