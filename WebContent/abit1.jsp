    ...
    <tbody class="dark">            
     ...
     <tr>
         ...
         <td vAlign="middle" height="18">
           ...
           Серия:&nbsp;<html:text value="" name="abit_A" styleClass="text_f9_short" property="seriaDokumenta" size="6" maxlength="20" tabindex="9"/>&nbsp;&nbsp;
     ...
     <tr>
         ...
         <td vAlign="middle" height="18">
           ...
           Код&nbsp;подразделения:&nbsp;<html:text value="" name="abit_A" styleClass="text_f9_short" property="zajavlen" size="8" maxlength="8"/></td>
     </tr>
     <tr>
   ...
   <table border="1" cellSpacing="0" cellPadding="0" FRAME="BOX" class="text" width="100%">
    ...
    <tbody class="dark">
     ...
     <tr>
      ...
      <tr>
         <td vAlign="middle" height="18">&nbsp;&nbsp;Тип&nbsp;оконч.&nbsp;заведения:&nbsp;</td>
         <td vAlign="middle" height="18">
