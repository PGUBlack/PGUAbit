...
<logic:notPresent name='listsSpecAction' scope='request'>
 <logic:redirect forward='lists_spec'/>
</logic:notPresent>

<logic:notPresent name="listsSpecForm" property="action">
...
<logic:present name="listsSpecForm" property="action">
<bean:define id="action" name="listsSpecForm" property="action"/>
...
<BR>
<html:form action="/lists_spec?action=viewing" onsubmit="return checkFields();">
...
<html:form method="post" action="/lists_spec?action=null">
...
%>
<BR>
<html:form action="/lists_spec?action=report">
...
<html:form action="/lists_spec.do?action=view">
