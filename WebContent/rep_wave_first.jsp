...
<logic:notPresent name='waveFirstAction' scope='request'>
 <logic:redirect forward='rep_wave_first'/>
</logic:notPresent>

<logic:notPresent name="waveFirstForm" property="action">
...
<logic:present name="waveFirstForm" property="action">
<bean:define id="action" name="waveFirstForm" property="action"/>
...
<BR>
<html:form action="/rep_wave_first?action=report" onsubmit="return checkFields();">
