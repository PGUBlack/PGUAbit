...
<%------------------------------------------%>
   <table border="1" cellSpacing="0" cellPadding="0" FRAME="BOX" class="text" width="100%">
    ...
    <%-- 
     <tr>
         ...
         <html:select styleClass="select_f1" name="abit_A" property="special8" tabindex="33">
 ...
 <html:option value="0">нет</html:option>
     ...
     <tr>
         ...
         <td vAlign="middle" height="18">
         <html:select styleClass="select_f1" name="abit_A" property="special222" tabindex="37">
 <html:option value="0">нет</html:option>
           <html:option value="да">да</html:option>
           </html:select>
         </td>
     ...
     <tr>
         ...
         <td vAlign="middle" height="18">
         <html:select styleClass="select_f1" name="abit_A" property="shifrKursov" tabindex="38">
          <html:option value="0">нет</html:option>
           <html:option value="да">да</html:option>
           </html:select>
         </td>
