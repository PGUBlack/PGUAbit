...
<logic:notPresent name='krymAction' scope='request'>
 <logic:redirect forward='krym'/>
</logic:notPresent>

<logic:notPresent name="krymForm" property="action">
...
<logic:present name="krymForm" property="action">
<bean:define id="action" name="krymForm" property="action"/>
...
<template:put name='title'>Список абитуриентов из Крыма</template:put>
<template:put name="target_name">Список абитуриентов из Крыма</template:put>
<template:put name="sub_name">предварительный</template:put>
<template:put name='content'>
<BR>
<html:form action="/krym?action=report" onsubmit="return checkFields();">
...
<tr><td><font class="text_10">Ранжирование:</font></td>
    <td>
       <html:select styleClass="select_f1" name="abit_SD" property="special7" tabindex="2">
         <html:option value="1">По баллам</html:option>
         <html:option value="2">По алфавиту</html:option>
      </html:select> 
    </td>
</tr>
</table>
...
<html:form method="post" action="/krym?action=null">
