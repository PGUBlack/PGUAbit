...
<logic:notPresent name='waveSecondAction' scope='request'>
 <logic:redirect forward='rep_wave_second'/>
</logic:notPresent>

<logic:notPresent name="waveSecondForm" property="action">
...
<logic:present name="waveSecondForm" property="action">
<bean:define id="action" name="waveSecondForm" property="action"/>
...
<template:put name="sub_name">рекомендованных к зачислению и находящихся в резерве</template:put>
<template:put name='content'>
<BR>
<html:form action="/rep_wave_second?action=report" onsubmit="return checkFields();">
...
<html:form method="post" action="/rep_wave_second?action=null">
