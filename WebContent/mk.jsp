...
<logic:notPresent name='mkAction' scope='request'>
 <logic:redirect forward='mk'/>
</logic:notPresent>

<logic:notPresent name="mkForm" property="action">
...
<logic:present name="mkForm" property="action">
<bean:define id="action" name="mkForm" property="action"/>
...
<BR>
<html:form action="/mk?action=report" onsubmit="return checkFields();">
...
<html:form method="post" action="/mk?action=null">
