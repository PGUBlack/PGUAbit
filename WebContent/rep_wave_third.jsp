...
<logic:notPresent name='waveThirdAction' scope='request'>
 <logic:redirect forward='rep_wave_third'/>
</logic:notPresent>

<logic:notPresent name="waveThirdForm" property="action">
...
<logic:present name="waveThirdForm" property="action">
<bean:define id="action" name="waveThirdForm" property="action"/>
...
<BR>
<html:form action="/rep_wave_third?action=report" onsubmit="return checkFields();">
...
<html:form method="post" action="/rep_wave_third?action=null">
