...
<logic:notPresent name='listsDoneAction' scope='request'>
 <logic:redirect forward='rep_lists_done'/>
</logic:notPresent>
...
<template:put name='title'>Списки групп с полученными оценками</template:put>
<template:put name="target_name">Списки по группам с полученными оценками</template:put>
<template:put name="sub_name">Выберите параметры</template:put>
<template:put name='content'>
<BR>
<html:form action="/rep_lists_done?action=viewing&offset" onsubmit="return checkFields();">
...
<html:form method="post" action="/rep_lists_done?action=null">
...
<template:put name='title'>Списки групп с полученными оценками</template:put>
<template:put name="target_name">Список группы с экзаменационными оценками</template:put>
<template:put name='content'>
<BR>
<html:form action="/rep_lists_done?action=report">
...
<html:form action="/rep_lists_done.do?action=view">
