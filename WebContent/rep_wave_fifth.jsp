...
<logic:notPresent name='waveFifthAction' scope='request'>
 <logic:redirect forward='rep_wave_fifth'/>
</logic:notPresent>

<logic:notPresent name="waveFifthForm" property="action">
...
<logic:present name="waveFifthForm" property="action">
<bean:define id="action" name="waveFifthForm" property="action"/>
...
<template:put name="target_name">Финальный список абитуриентов второго этапа</template:put>
<template:put name="sub_name">претендующих на вакансии и имеющих оригинал</template:put>
<template:put name='content'>
<BR>
<html:form action="/rep_wave_fifth?action=report" onsubmit="return checkFields();">
...
<html:form method="post" action="/rep_wave_fifth?action=null">
