...
<logic:notPresent name='ordAction' scope='request'>
 <logic:redirect forward='ord'/>
</logic:notPresent>

<logic:notPresent name="ordForm" property="action">
...
<logic:present name="ordForm" property="action">
<bean:define id="action" name="ordForm" property="action"/>
...
<BR>
<html:form action="/ord?action=report" onsubmit="return checkFields();">
...
<html:form method="post" action="/ord?action=null">
