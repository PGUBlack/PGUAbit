...
<logic:notPresent name='intAction' scope='request'>
 <logic:redirect forward='int'/>
</logic:notPresent>

<logic:notPresent name="intForm" property="action">
...
<logic:present name="intForm" property="action">
<bean:define id="action" name="intForm" property="action"/>
...
<BR>
<html:form action="/int?action=report" onsubmit="return checkFields();">
...
<html:form method="post" action="/int?action=null">
