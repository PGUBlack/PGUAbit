...
<template:put name="target_name">Сводка по экзамену</template:put>
<template:put name="sub_name">Выберите дату</template:put>
<template:put name='title'>Сводка по экзамену</template:put>
...
<tr align=center>
  <td><html:submit styleClass="button" onclick="sohrSel()" tabindex="5" value="Просмотр"/></td>
</html:form>
...
<font class="text_11">
Предмет:&nbsp;<bean:write name="abit_O" property="nazvanie"/>
<br><br>Дата:&nbsp;<bean:write name="abit_O" property="data"/>
</font>
<br><br>
...
<td align=center><font class="text_th">&nbsp;10&nbsp;и&nbsp;0&nbsp;</font></td>
<td align=center><font class="text_th">&nbsp;с&nbsp;9&nbsp;по&nbsp;1&nbsp;</font></td>
</tr>
</thead>
