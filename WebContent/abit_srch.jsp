...
<html:form action="/abit_srch?action=searching&offset" onsubmit="return checkFields();">
<html:hidden name="abit_A" property="shifrkursov" value="*"/>
<html:hidden name="abit_A" property="trudovajadejatelnost" value="*"/>
<html:hidden name="abit_A" property="nujdaetsjaVObschejitii" value="*"/>
<html:hidden name="abit_A" property="sobesedovanie" value="*"/>
...
<tr>
<td><html:radio name="abit_A" property="priznakSortirovki" value="nazv_DipSpec"/>
<td valign=center><font class="text_9">&nbsp;Область</font></td>
<td valign=center>
     <html:select onchange="regionChange();" name="abit_A" styleClass="select_f1"  property="nazv_DipSpec" tabindex="2">
           <html:option value="-"/>
           <html:options collection="abit_A_Kladr" property="special27" labelProperty="special28"/>
          </html:select>
</td>
<td width=1%></td>
<td><html:radio name="abit_A" property="priznakSortirovki" value="need_Spo"/>
<td valign=center><font class="text_9">&nbsp;Район:</font></td>
<td valign=center>
    <html:select onchange='rajonChange();' name="abit_A" styleClass="select_f1" property="need_Spo" tabindex="2">
           <html:option value="-"/>
    </html:select>
...
<tr>
<td><html:radio name="abit_A" property="priznakSortirovki" value="gorod_Prop"/>
	  <td valign=center><font class="text_9">&nbsp;Пункт:</font></td>
 <td> <html:select name="abit_A" styleClass="select_f1" property="gorod_Prop" tabindex="2">
           <html:option value="-"/>
           </html:select> 
</td>
</tr>
...
<td valign=center><font class="text_9">&nbsp;Медицинская справка:</font></td>
<td valign=center>
...
<html:form action="/abiturient.do">
  <td><html:submit styleClass="button" value="Добавить абит-та" tabindex="54"/></td>
</html:form>
