...
public class WaveFourthAction extends Action {
    ...
    {   
        ...
        request.setAttribute( "waveFourthAction", new Boolean(true) );
...
/*********  Получение соединения с БД и ведение статистики  ***********/
          ...
          request.setAttribute( "waveFourthForm", form );
...
/***************************************************/
   if(abit_SD.getSpecial5() != null && (abit_SD.getSpecial5().equals("jnrfpfnmdpfxbcktybb") || abit_SD.getSpecial5().equals("jnrfpdpfxbcktybb"))) {
     stmt3 = conn.createStatement();
     stmt3.executeUpdate("UPDATE Konkurs SET Zach='н' WHERE Zach IN ('р','в') AND KodAbiturienta IN (SELECT KodAbiturienta FROM Abiturient WHERE TipDokSredObraz LIKE 'к')");
...
// Мешали спец-ти Сур.Тал.    query.append(" AND (m.ShifrMedali IN ('о','к') AND (s.ShifrSpetsialnosti IN ("+Constants.Sur_Talants_NO_KONKURS+"))) ");
