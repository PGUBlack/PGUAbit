...
/*****************  Возврат к предыд+ущей странице   *******************/
...
/********************** Подготовка данных для ввода с помощью селекторов ************************/
	 ...
	 int WidthOfTablo = 0;                          //Сюда накапливаем сумму ширины всех выбраных столбцов
       String MassForCol[][]   = new String[60][2];	//Массив, в который будут записаны имена
	 								//выводимых столбцов

	 if(abit_Srch.getDokumentyHranjatsja()!=null)	//Если содержимое BEANa непусто, то
									//столбец был выбран
	 {
	...
	/* if(abit_Srch.getShifrKursov()!=null)
	 ...
	 {
	  MassForCol[Integer.parseInt(abit_Srch.getMedal())][0] = "Индивид. достижения";
...
*/
	 ...
	 {
	  MassForCol[Integer.parseInt(abit_Srch.getLgoty())][0] = "Особые права";
	...
	/* if(abit_Srch.getTrudovajaDejatelnost()!=null)
	 ...
	 {
	  MassForCol[Integer.parseInt(abit_Srch.getAttestat())][0] = "Номер мед. справки";
...
/************************************************/
    ...
    String name = "Результаты поиска от "+StringUtil.CurrDate(".")+" на "+StringUtil.CurrTime(":");
...
/****************************** Выборка абитуриентов из БД ******************************/
  String MasSelector[][] = new String[60][2];	//Массив предназначен для сохранения
