...
public class KrymAction extends Action {
    ...
    {   
        ...
        request.setAttribute( "krymAction", new Boolean(true) );
...
/*********  Получение соединения с БД и ведение статистики  ***********/
          ...
          request.setAttribute( "krymForm", form );
...
// ИСХОДНЫЕ ПАРАМЕТРЫ
  ...
  String name = "Список абитуриентов 1-го этапа (Крым.) "+AF+" ";

  String file_con = "lists_"+StringUtil.toEng(AF)+"_predv_krym";
...
/**********************************************************/
  ...
  query = new StringBuffer("SELECT DISTINCT f.AbbreviaturaFakulteta,s.ShifrSpetsialnosti,s.Abbreviatura,s.NazvanieSpetsialnosti,s.KodSpetsialnosti,s.PlanPriema,s.TselPr_PGU,s.TselPr_ROS,s.PlanPriemaDog,f.kodfakulteta FROM Fakultety f,Spetsialnosti s, Konkurs kon, Abiturient a,Forma_Obuch fo WHERE a.kodoblastip IN('9100000000000','9200000000000') AND f.KodFakulteta=s.KodFakulteta AND a.KodAbiturienta=kon.KodAbiturienta AND kon.KodSpetsialnosti=s.KodSpetsialnosti AND s.KodFakulteta LIKE '"+KF+"' AND s.edulevel IN ('с','б')");
...
// ОЛИМПИЙЦЫ (без вступительных испытаний)
    ...
    query1= new StringBuffer("SELECT a.KodAbiturienta,kon.NomerLichnogoDela,a.Familija,a.Imja,a.Otchestvo,a.TipDokSredObraz,l.ShifrLgot,kon.PR,a.viddoksredobraz, SUM(zso.OtsenkaEge)\"SummaEge\" FROM Abiturient a,ZajavlennyeShkolnyeOtsenki zso, Spetsialnosti s, NazvanijaPredmetov np,EkzamenyNaSpetsialnosti ens,Konkurs kon, Lgoty l, abitdopinf adi WHERE a.kodoblastip IN('9100000000000','9200000000000') AND adi.BallAtt not like 'да' AND adi.ballsgto not like 'да' AND adi.ballzgto not like 'да' AND adi.ballsoch not like 'да' AND adi.ballpoi not like 'да' and adi.trudovajadejatelnost not like 'да' AND kon.op=l.kodlgot AND kon.KodAbiturienta=a.KodAbiturienta AND kon.KodSpetsialnosti=s.KodSpetsialnosti AND a.KodAbiturienta=zso.KodAbiturienta AND kon.KodSpetsialnosti=ens.KodSpetsialnosti AND zso.KodPredmeta=np.KodPredmeta AND a.KodAbiturienta=zso.KodAbiturienta AND ens.KodPredmeta=zso.KodPredmeta AND kon.KodSpetsialnosti LIKE "+rs2.getString(5)+" AND a.DokumentyHranjatsja LIKE 'д' AND a.KodAbiturienta NOT IN ("+excludeList.toString()+")");
...
//Мешали спец-ти СурТал    query.append(" AND (m.ShifrMedali IN ('о','к') AND (s.ShifrSpetsialnosti IN ("+Constants.Sur_Talants_NO_KONKURS+"))) ");
    ...
    query1.append(" AND (l.shifrlgot IN ('о','к','ск','ик')) ");
...
String s=null;
    ...
    stmt10 = conn.prepareStatement("SELECT Shifr,F,I,O,ko,sum,pr1,pr2,pr3,pr4,op,pp,ka,ind,ind1,ind2,ind3,ind4,ind5 FROM Forsen WHERE vd like '%аттестат%' ORDER BY "+spis+"");
    rs10=stmt10.executeQuery();
   N=1;
  ...
  //  rs = stmt.executeQuery(query.toString());
   ...
   //     report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n"); //Nomer
       ...
       /* report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx1900\n"); //Shifr
        report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx3800\n");	//FIO
        report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx4300\n"); //KO
        ...
        report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx5700\n"); //ekz1
        report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx6400\n"); //ekz2
        ...
        report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx8500\n"); //op
        report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx9200\n"); //pp
        report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx9900\n"); //ind 
        report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx10600\n"); //att
        report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx11300\n"); //spd
        report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx12000\n"); //trud
        report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx12700\n"); //olimp
        report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx13400\n"); //soch
*/  
...
//Добавляем код абитуриента в список исключения для того, чтобы он появлялся в отчете только один раз
    ...
    header=false;
    stmt10 = conn.prepareStatement("SELECT Shifr,F,I,O,ko,sum,pr1,pr2,pr3,pr4,op,pp,ka,ind,ind1,ind2,ind3,ind4,ind5 FROM Forsen WHERE vd like '%диплом%' ORDER BY "+spis+"");
    rs10=stmt10.executeQuery();
   N=1;
   // stmt = conn.createStatement();
  //  rs = stmt.executeQuery(query.toString());
    while(rs10.next()) {
      ...
      if(header == false) {
        header = true;
        report.write("\\pard\\par\n");
        report.write("\\b1\\ql\\fs28{Перечень лиц, имеющих право на прием без вступительных испытаний, поступающих на базе профессионального образования}\\b0\\par\\par\n"); 
    //    report.write("\\fs16 \\b0 \\qc \\trowd \\trhdr\\trqc\\trgaph58\\trrh80\\trleft36\n");
        report.write("\\fs22\\b1 \\trowd \\trqc\\trgaph108\\trrh280\\trleft36\\trhdr\n");
        report.write("\\clvmgf\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n");//Nomer
   //     report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n"); //Nomer
...
*/  
   ...
   //     report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n"); //Nomer
      ...
      report.write("\\intbl\\qc "+rs10.getString(5)+"\\cell\n"); //ko
      stmt3 = conn.createStatement();
      rs3 = stmt3.executeQuery("SELECT kon.prof FROM konkurs kon WHERE kon.kodabiturienta LIKE '"+rs10.getInt(13)+"' AND kon.KodSpetsialnosti LIKE '"+rs2.getString(5)+"'");
      if(rs3.next()) {
      	sob=rs3.getInt(1);
      }
      int sum=sob+rs10.getInt(14);
      report.write("\\intbl\\qc "+sum+"\\cell\n"); // sum
      report.write("\\intbl\\qc "+sob+"\\cell\n"); // sum
      report.write("\\intbl\\qc "+rs10.getString(11)+"\\cell\n"); //op
      report.write("\\intbl\\qc "+rs10.getString(12)+"\\cell\n"); //pp
      report.write("\\intbl\\qc "+rs10.getString(14)+"\\cell\n"); //ind
   //   report.write("\\intbl\\qc "+(summ)+"\\cell\n");
...
rs10=stmt10.executeQuery();
  ...
  */  
          ...
          report.write("\\fs22\\b1 \\trowd \\trqc\\trgaph108\\trrh280\\trleft36\\trhdr\n");
          report.write("\\clvmgf\\clvertalc \\clbrdrb\\brdrs\\brdrw20\\brdrcf1 \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n");//Nomer
     //     report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n"); //Nomer
        ...
        //  rs = stmt.executeQuery(query.toString());
          ...
          while(rs10.next()) {
            if(header == false) {
          	  header = true;
                report.write("\\pard\\par\n");
                report.write("\\b1\\ql\\fs28{Перечень лиц, поступающих на базе профессионального образования, имеющих особые права и поступающих на места в пределах квоты приема: "+total_lgn+"}\\b0\\par\\par\n"); 
            //    report.write("\\fs16 \\b0 \\qc \\trowd \\trhdr\\trqc\\trgaph58\\trrh80\\trleft36\n");
                report.write("\\fs22\\b1 \\trowd \\trqc\\trgaph108\\trrh280\\trleft36\\trhdr\n");
                report.write("\\clvmgf\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n");//Nomer
           //     report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n"); //Nomer
        ...
        */  
         ...
         //   report.write("\\intbl\\qc "+(summ)+"\\cell\n");
          ...
          report.write("\\intbl\\qc "+rs10.getString(19)+"\\cell\n"); // 
            ...
            N++;
      //Добавляем код абитуриента в список исключения для того, чтобы он появлялся в отчете только один раз
            rs3 = stmt3.executeQuery("select a.kodabiturienta from abiturient a, konkurs k where k.target NOT LIKE '1' AND a.kodabiturienta=k.kodabiturienta AND k.kodspetsialnosti LIKE '"+rs2.getString(5)+"' AND a.kodabiturienta LIKE '"+rs10.getString(13)+"'");
            if(!rs3.next()){
            excludeList.append(","+rs10.getString(13));
            }
          }
...
stmt10 = conn.prepareStatement("SELECT Shifr,F,I,O,ko,sum,pr1,pr2,pr3,pr4,op,pp,ka,ind,ind1,ind2,ind3,ind4,ind5,p1,p2,p3,Stob FROM Forsen WHERE vd like '%аттестат%' ORDER BY "+spis+"");
rs10=stmt10.executeQuery();
     N=1;
     num=nomer+StringUtil.toInt(rs.getString(1),0);
     // stmt = conn.createStatement();
    //  rs = stmt.executeQuery(query.toString());
      while(rs10.next()) {
...
// Добавляем строки целевиков с надписью "вакантно"
     /* for(;tselev_nomer<total_amount;tselev_nomer++) {
      ...
      stmt10 = conn.prepareStatement("SELECT Shifr,F,I,O,ko,sum,pr1,pr2,pr3,pr4,op,pp,ka,ind,ind1,ind2,ind3,ind4,ind5,p1,p2,p3,Stob FROM Forsen WHERE vd like '%диплом%' ORDER BY "+spis+"");
      rs10=stmt10.executeQuery();
           N=1;
          ...
          //  rs = stmt.executeQuery(query.toString());
            while(rs10.next()) {
            	...
            	if(header == false) {
                    header = true;
                    report.write("\\pard\\par\n");
                    report.write("\\b1\\ql\\fs28{Перечень лиц, поступающих на базе профессионального образования по целевому приему (в интересах органов гос. власти) в пределах квоты: "+rs.getString(1)+"}\\b0\\par\\par\n"); 
                    //    report.write("\\fs16 \\b0 \\qc \\trowd \\trhdr\\trqc\\trgaph58\\trrh80\\trleft36\n");
                    report.write("\\fs22\\b1 \\trowd \\trqc\\trgaph108\\trrh280\\trleft36\\trhdr\n");
                    report.write("\\clvmgf\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n");//Nomer
               //     report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n"); //Nomer
    	          ...
    	          //  rs = stmt.executeQuery(query.toString());
    	            while(rs10.next()) {
    	       	      ...
    	       	      if(header == false) {
    	       	          header = true;
    	       	          report.write("\\pard\\par\n");
    	       	          report.write("\\b1\\ql\\fs28{Перечень лиц, поступающих на базе профессионального образования по целевому приему (в интересах предприятий Росатома) в пределах квоты: "+rs.getString(1)+"}\\b0\\par\\par\n"); 
    	       	          //    report.write("\\fs16 \\b0 \\qc \\trowd \\trhdr\\trqc\\trgaph58\\trrh80\\trleft36\n");
    	       	          report.write("\\fs22\\b1 \\trowd \\trqc\\trgaph108\\trrh280\\trleft36\\trhdr\n");
    	       	          report.write("\\clvmgf\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n");//Nomer
    	       	     //     report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n"); //Nomer
    	          ...
    	          //  rs = stmt.executeQuery(query.toString());
    	            while(rs10.next()) {
    	            	 ...
    	            	 if(header == false) {
    	       	          header = true;
    	       	          report.write("\\pard\\par\n");
    	       	          report.write("\\b1\\ql\\fs28{Перечень лиц, поступающих на базе профессионального образования по целевому приему (в интересах предприятий Роскосмоса) в пределах квоты: "+rs.getString(1)+"}\\b0\\par\\par\n"); 
    	       	          //    report.write("\\fs16 \\b0 \\qc \\trowd \\trhdr\\trqc\\trgaph58\\trrh80\\trleft36\n");
    	       	          report.write("\\fs22\\b1 \\trowd \\trqc\\trgaph108\\trrh280\\trleft36\\trhdr\n");
    	       	          report.write("\\clvmgf\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n");//Nomer
    	       	     //     report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n"); //Nomer
    	    ...
    	    //  rs = stmt.executeQuery(query.toString());
    	      while(rs10.next()) {
    	    	  ...
    	    	  if(header == false) {
    	    	        header = true;
    	    	        report.write("\\pard\\par\n");
    	    	        report.write("\\b1\\ql\\fs28{Перечень лиц, поступающих на базе среднего общего образования по целевому приему (в интересах предприятий Роспромторга ) в пределах квоты: "+rs.getString(1)+"}\\b0\\par\\par\n"); 
    	    	        //    report.write("\\fs16 \\b0 \\qc \\trowd \\trhdr\\trqc\\trgaph58\\trrh80\\trleft36\n");
    	    	            report.write("\\fs22\\b1 \\trowd \\trqc\\trgaph108\\trrh280\\trleft36\\trhdr\n");
    	    	            report.write("\\clvmgf\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n");//Nomer
    	    	       //     report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n"); //Nomer
    	          ...
    	          //  rs = stmt.executeQuery(query.toString());
    	            while(rs10.next()) {
    	            	 ...
    	            	 if(header == false) {
    	       	          header = true;
    	       	          report.write("\\pard\\par\n");
    	       	          report.write("\\b1\\ql\\fs28{Перечень лиц, поступающих на базе профессионального образования по целевому приему (в интересах предприятий Роспромторга ) в пределах квоты: "+rs.getString(1)+"}\\b0\\par\\par\n"); 
    	       	          //    report.write("\\fs16 \\b0 \\qc \\trowd \\trhdr\\trqc\\trgaph58\\trrh80\\trleft36\n");
    	       	          report.write("\\fs22\\b1 \\trowd \\trqc\\trgaph108\\trrh280\\trleft36\\trhdr\n");
    	       	          report.write("\\clvmgf\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n");//Nomer
    	       	     //     report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n"); //Nomer
        ...
        //  rs = stmt.executeQuery(query.toString());
          while(rs10.next()) {
        	  ...
        	  if(header == false) {
        	        ...
        	        report.write("\\pard\\par\n");
        	        if(abit_SD.getPriznakSortirovki().equals("budgetniki")){
        	        	report.write("\\b1\\ql\\fs28{Перечень лиц, поступающих на базе профессионального образования по общему конкурсу на места в рамках контрольных цифр приема}\\b0\\par\\par\n"); 
        	        }else{
        	        	report.write("\\b1\\ql\\fs28{Перечень лиц, поступающих на базе профессионального образования, подавших документы по договору об оказании платных образовательных услуг}\\b0\\par\\par\n");
        	        }//    report.write("\\fs16 \\b0 \\qc \\trowd \\trhdr\\trqc\\trgaph58\\trrh80\\trleft36\n");
        	        report.write("\\fs22\\b1 \\trowd \\trqc\\trgaph108\\trrh280\\trleft36\\trhdr\n");
        	        report.write("\\clvmgf\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n");//Nomer
        	   //     report.write("\\clvertalc \\clbrdrb\\brdrs \\brdrdb\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx500\n"); //Nomer
