...
public class ListsEdoneAction extends Action {
    ...
    {   
        ...
        boolean              rep_lists_edone_f  = false;
        boolean              error              = false;
        ...
        request.setAttribute( "listsEdoneAction", new Boolean(true) );
...
/************************************************/
        ...
        String name = "Список группы "+abit_SD.getGruppa().toUpperCase()+" с экз. оц. и ЕГЭ";

        String file_con = new String("list_ex_ots_ege_"+StringUtil.toEng(abit_SD.getGruppa()));
        ...
        rs = stmt.executeQuery();
        if(rs.next()) 
          report.write("\\fs36\\qc\\b1{"+rs.getString(1)+"}\\b0\n");

          report.write("\\par\\fs28\\par\\b0\\qc Список абитуриентов группы \\b{"+ abit_SD.getGruppa() +"}\\b0  с экз. оценками и баллами ЕГЭ\\b1\\n");
...
// Формирование таблицы отчета
  ...
  report.write("\\clvmgf\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx3600\n"); //ф
  report.write("\\clvmgf\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx4900\n"); //и
  ...
  report.write("\\clvmgf\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx7300\n"); // шм
  report.write("\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrb\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx"+(7300+count_predm*450)+"\n"); // предметы / оценки / баллы ЕГЭ

  report.write("\\intbl\\qc № \\cell\n");
  report.write("\\intbl Абб. спец \\cell\n");
  report.write("\\intbl НЛД \\cell\n");
  ...
  report.write("\\intbl Предметы / Оценки / Баллы ЕГЭ\\cell\n");
  ...
  report.write("\\clvmrg\\clvertalc \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrb\\brdrdb \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx3600\n");
  report.write("\\clvmrg\\clvertalc \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrb\\brdrdb \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx4900\n");
  report.write("\\clvmrg\\clvertalc \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrb\\brdrdb \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx6400\n");
  report.write("\\clvmrg\\clvertalc \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrb\\brdrdb \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx7300\n");
  for(int col=1;col<=count_predm/2;col++)
    report.write("\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrb\\brdrdb \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx"+(7300+col*2*450)+"\n");
  ...
  report.write("\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrb\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx3600\n");
  report.write("\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrb\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx4900\n");
  report.write("\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrb\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx6400\n");
  report.write("\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrb\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx7300\n");
  for(int col=1;col<=count_predm;col++)
    report.write("\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrb\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx"+(7300+col*450)+"\n");
...
// Выборка данных по абитуриенту для вывода их в отчет
   ...
   stmt = conn.prepareStatement("SELECT a.KodAbiturienta,s.Abbreviatura,g.Gruppa,a.NomerLichnogoDela,a.Familija,a.Imja,a.Otchestvo,m.ShifrMedali,o.Otsenka,zo.OtsenkaEge,np.KodPredmeta FROM Abiturient a,Otsenki o,ZajavlennyeShkolnyeOtsenki zo,Spetsialnosti s,Medali m,Gruppy g,NazvanijaPredmetov np WHERE np.KodPredmeta=o.KodPredmeta AND np.KodPredmeta=zo.KodPredmeta AND zo.KodAbiturienta=a.KodAbiturienta AND zo.KodPredmeta=o.KodPredmeta AND a.KodAbiturienta=o.KodAbiturienta AND a.KodMedali=m.KodMedali AND a.KodSpetsialnosti=s.KodSpetsialnosti AND a.KodGruppy=g.KodGruppy AND g.KodGruppy LIKE ? AND o.KodPredmeta IN (SELECT DISTINCT np.KodPredmeta FROM NazvanijaPredmetov np, EkzamenyNaSpetsialnosti ens, Gruppy g,Abiturient a WHERE ens.KodPredmeta=np.KodPredmeta AND ens.KodSpetsialnosti=a.KodSpetsialnosti AND a.KodGruppy=g.KodGruppy AND g.KodGruppy LIKE ? AND a.KodVuza LIKE ?) GROUP BY a.KodAbiturienta,s.Abbreviatura,g.Gruppa,a.NomerLichnogoDela,a.Familija,a.Imja,a.Otchestvo,m.ShifrMedali,o.Otsenka,zo.OtsenkaEge,np.KodPredmeta,g.KodGruppy ORDER BY Familija,Imja,Otchestvo,a.KodAbiturienta,np.KodPredmeta ASC");
   stmt.setObject(1,new Integer(abit_SD.getSpecial1()),Types.INTEGER);
...
rs = stmt.executeQuery();
if(rs.next()) {
  name = "Списки групп "+rs.getString(1).toUpperCase()+" с экз. оц. и ЕГЭ";
  file_con = new String("lists_ex_ots_ege_"+StringUtil.toEng(rs.getString(1).toUpperCase()));
}
  ...
  while(rs_a.next()){
	...
	int b=0;
        ...
        if(rs.next()) 
          ...
          report.write("\\par\n");
          report.write("\\par\\fs28 \\b0 \\qc Список абитуриентов группы \\b"+ rs_a.getString(1) +" \\b0 с экз. оценками и баллами ЕГЭ\\b1\\n");
          report.write("\\fs14\\par\\par\\fs28");
...
/*************************** Выборка числа абитуриентов из БД ****************************/
                 ...
                 abit_SD.setPredmCount(""+(kol_predm*2));
...
// Количество абитуриентов в группе
        ...
        if(rep_lists_edone_f) return mapping.findForward("rep_lists_edone_f");
