...
// ИСХОДНЫЕ ПАРАМЕТРЫ
  ...
  String name = "Список подавших заявление в Многопрофильный Колледж(предв.) "+AF;
...
//System.out.println(query);
   ...
   //     report.write("\\clvmgf\\clvertalc \\clbrdrt\\brdrs\\brdrw20\\brdrcf1 \\clbrdrl\\brdrs\\brdrw20\\brdrcf1 \\clbrdrr\\brdrs\\brdrw20\\brdrcf1 \\cellx12000\n");//pp
        ...
        report.write("\\intbl{Среднее}\\par{кол-во}\\par{баллов}\\cell\n");
        report.write("\\intbl{Баллы}\\par{за}\\par{атт.}\\cell\n");
