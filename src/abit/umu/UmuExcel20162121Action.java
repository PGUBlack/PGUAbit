...
public class UmuExcel20162121Action extends Action {
...
/**********************************************************************/
          ...
          cell = cells.get("A4");
          cells.setColumnWidth(0, 130);
          cell.setValue("Раздел 2.1.2. Распределение численности студентов и выпуска по направлениям подготовки и специальностям");
...
//************************************************
    	  ...
    	  // Всего - 1 курс
		  PreparedStatement stmt3 = conn.prepareStatement("select count(a.kodspetsialnzach) from abiturient a where kodspetsialnzach = ? and a.prinjat not like 'н'");
    	  ...
    	  // Из них за счет бюджетных ассигнований федерального бюджета - 1 курс
		  PreparedStatement stmt4 = conn.prepareStatement("select count(a.kodspetsialnzach) from abiturient a where kodspetsialnzach = ? and a.prinjat not like 'н' and a.prinjat not like 'д'");
		  ...
		  PreparedStatement stmt5 = conn.prepareStatement("select count(a.kodspetsialnzach) from abiturient a where kodspetsialnzach = ? and a.prinjat not like 'н'");
    	  ...
    	  // За счет бюджетных ассигнований федерального бюджета (сумма гр.6,8,10,12,14,16,18)
		  ...
		  PreparedStatement stmt7 = conn.prepareStatement("select count(a.kodspetsialnzach) from abiturient a where kodspetsialnzach = ? and a.prinjat like 'д'");
