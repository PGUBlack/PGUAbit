...
public class UmuExcel20162142Action extends Action {
...
/**********************************************************************/
          ...
          cell = cells.get("l5");
          cell.setValue("Продолжение подраздела 2.1.4");      
          
          cell = cells.get("g6");
          cell.setValue("Из него (из гр.22):"); 
          
          cell = cells.get("l6");
          cell.setValue("Из него (из гр.26):");    
...
//************************************************
		  ...
		  PreparedStatement stmt3 = conn.prepareStatement("select count(a.kodspetsialnzach) from abiturient a where kodspetsialnzach = ? and a.prinjat not like 'н' and a.pol = 'ж' and a.grajdanstvo not like 'РФ' and a.grajdanstvo not like 'Российская Федерация' and a.grajdanstvo not like 'нет гражданства'");
