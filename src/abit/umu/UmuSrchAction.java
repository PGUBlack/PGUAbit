...
public class UmuSrchAction extends Action {
...
/****************************** Выборка абитуриентов из БД ******************************/
                    ...
                    query.append("AND AbitDopInf.KodAbiturienta=Abiturient.KodAbiturienta AND Gruppy.KodGruppy=Abiturient.KodGruppy AND Spetsialnosti.KodFakulteta = Fakultety.KodFakulteta AND Abiturient.KodZavedenija = Zavedenija.KodZavedenija  AND Abiturient.KodVuza = ");
...
/// abit_A.setSpecial1(query.toString());
 System.out.println(query);
                    ...
                    queryTotal.append(" AbitDopInf.KodAbiturienta=Abiturient.KodAbiturienta AND Gruppy.KodGruppy=Abiturient.KodGruppy AND Spetsialnosti.KodFakulteta = Fakultety.KodFakulteta AND Abiturient.KodZavedenija = Zavedenija.KodZavedenija AND Abiturient.KodVuza=");
...
// Начало выборки
 ...
 //    abit_TMP.setNazvanieOblasti(rs.getString(23));
   ...
   //  abit_TMP.setBall(new Integer(rs.getInt(33)));
     abit_TMP.setPrinjat(rs.getString(34));
