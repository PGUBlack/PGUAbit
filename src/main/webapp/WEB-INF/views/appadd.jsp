...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  ...
  <main class="mdl-layout__content">
      <div class="page-content">
        <form:form method="post" modelAttribute="app" accept-charset="UTF-8">
            <div class="card-wide mdl-shadow--3dp">
                <h4>1. Личные данные / Документы</h4>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <form:input path="lastname" cssClass="mdl-textfield__input" id="abit_lastname"/>
                    <label class="mdl-textfield__label" for="abit_lastname">Фамилия</label>
                </div>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <form:input path="firstname" cssClass="mdl-textfield__input" id="abit_firstname"/>
                    <label class="mdl-textfield__label" for="abit_firstname">Имя</label>
                </div>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <form:input path="secondname" cssClass="mdl-textfield__input" id="abit_secondname"/>
            ...
            <div class="submit">
                <input type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" value="Cохранить">
            </div>
        </form:form>
      </div>
  </main>
